...
public class TextMenu {
    ...
    public String updateMenu = "__________________________\n"
                            ...
                            + "3 - Изменить вес вероятности выпадения игрушки\n"
                            + "4 - Предварительный просмотр и сохранение\n"
                            + "0 - Вернуться  в меню\n";
    ...
    public String loserText = "Увы не выиграли!\n";

    public String winText = "Поздравляем! Вы выйграли!!!\n";
